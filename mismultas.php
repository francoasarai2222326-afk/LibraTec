...
$sql = "SELECT m.codigo, l.titulo, l.isbn, p.fecha_prestamo, p.fecha_devolucion, p.fecha_real_devolucion, p.estado, p.observaciones, m.monto, m.motivo, m.pagada
        FROM Multas m
...
<title>Mis Multas - LIBRATEC</title>
                ...
                <?php if ($result->num_rows > 0): ?>
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td><?php echo $row['pagada'] ? 'Sí' : 'No'; ?></td>
                        </tr>
                    <?php endwhile; ?>
                <?php else: ?>
                    <tr><td colspan="11">No tienes multas registradas.</td></tr>
                <?php endif; ?>
            </tbody>
        </table>
    </div>
