...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($autor === '') {
        ...
        // Insertar autor
        $sqlInsert = "INSERT INTO Autores (autor) VALUES (?)";
        $stmtInsert = $conn->prepare($sqlInsert);
        $stmtInsert->bind_param("s", $autor);

        if ($stmtInsert->execute()) {
            // Redirigir a autores.php después de agregar
            header("Location: autores.php");
            exit();
        } else {
            $mensaje = "Error al agregar el autor. Inténtalo de nuevo.";
        }
    }
}
?>
...
<title>Añadir Autor - LIBRATEC</title>
...
<main class="main">
    ...
    <form method="POST" action="añadirautor.php" autocomplete="off">
        ...
        <button type="submit" class="btn-submit"><i class="fa fa-save"></i> Guardar Autor</button>
    </form>

    <a href="autores.php" class="btn-cancel">Cancelar</a>
</main>
